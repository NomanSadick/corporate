...
export default function Hero() {
  return (
    <div className="bg-[linear-gradient(90deg,_#146B83_0%,_#1C627D_18%,_#2F4A6F_48%,_#0E1E44_84%)] text-white py-10 text-center">
      {/* <div className="bg-[url(/img/mountains.jpg)] ..."></div> */}
      <section className="container-custom">
        <div className="bg-[url(/images/Group.png)] bg-no-repeat bg-contain bg-center h-[250px] md:h-[400px]">
          ...
          {/* Subtext */}
          <p className="text-[16px] leading-[24px] md:text-[24px] md:leading-[30px] text-white/80 mt-3 max-w-[700px] mx-auto">
            Customized planning, dedicated agents, and exclusive deals —
            everything you need, exactly how you want it.
          </p>

          {/* Buttons with icons */}
          <div className="mt-6 flex justify-center flex-wrap gap-3">
            <button className="flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-semibold px-4 py-2 md:px-14 rounded-md text-sm">
              Submit Your Query
            </button>
